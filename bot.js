...
const STORAGE_ABI = [
  {
    inputs: [
      {
        internalType: 'contractTokenInterfaceV5',
        name: '_dai',
        type: 'address',
      },
      {
      ...
      {
        internalType: 'contractNftInterfaceV5[5]',
        name: '_nfts',
        type: 'address[5]',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contractPausableInterfaceV5',
        name: '',
        type: 'address',
      },
    ],
  ...
  },
  {
    ...
    name: 'dai',
    outputs: [
      { internalType: 'contractTokenInterfaceV5', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
    constant: true,
  ...
  },
  {
    ...
    name: 'nfts',
    outputs: [
      { internalType: 'contractNftInterfaceV5', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
    constant: true,
  ...
  },
  {
    ...
    name: 'pool',
    outputs: [
      { internalType: 'contractPoolInterfaceV5', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
    constant: true,
  },
  {
    ...
    outputs: [
      {
        internalType: 'contractAggregatorInterfaceV5',
        name: '',
        type: 'address',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'structGFarmTestnetTradingStorageV5.Trade',
        name: 'trade',
        type: 'tuple',
      },
      { internalType: 'uint256', name: 'block', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'index', type: 'uint256' },
      {
        internalType: 'enumGFarmTestnetTradingStorageV5.LimitOrder',
        name: 'orderType',
        type: 'uint8',
      },
    ],
  ...
  {
    inputs: [
      { internalType: 'address', name: '_tokenDaiRouter', type: 'address' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_maxTradesPerBlock', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      },
      {
        ...
        internalType: 'structGFarmTestnetTradingStorageV5.TradeInfo',
        name: '_tradeInfo',
        type: 'tuple',
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: 'structGFarmTestnetTradingStorageV5.PendingMarketOrder',
        name: '_order',
        type: 'tuple',
      },
    ...
    inputs: [
      {
        ...
        internalType: 'structGFarmTestnetTradingStorageV5.OpenLimitOrder',
        name: 'o',
        type: 'tuple',
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: 'structGFarmTestnetTradingStorageV5.PendingNftOrder',
        name: '_nftOrder',
        type: 'tuple',
      },
...
const TRADING_ABI = [
  {
    inputs: [
      {
        internalType: 'contractStorageInterfaceV5',
        name: '_storageT',
        type: 'address',
      },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        components: [
          {
            ...
            internalType: 'structStorageInterfaceV5.Trade',
            name: 'trade',
            type: 'tuple',
          },
          { internalType: 'uint256', name: 'block', type: 'uint256' },
        ...
        indexed: false,
        internalType: 'structStorageInterfaceV5.PendingMarketOrder',
        name: 'order',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'bool', name: 'done', type: 'bool' },
    ],
    name: 'Done',
    type: 'event',
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_limit', type: 'bool' },
      { internalType: 'uint256', name: '_spreadReductionId', type: 'uint256' },
  ...
  },
  {
    inputs: [
      {
        internalType: 'enumStorageInterfaceV5.LimitOrder',
        name: '_orderType',
        type: 'uint8',
      },
      { internalType: 'address', name: '_trader', type: 'address' },
...
const CALLBACKS_ABI = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_vaultFeeP', type: 'uint256' }],
    name: 'setVaultFeeP',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
    ...
    inputs: [
      {
        ...
        internalType: 'structGNSTestnetTradingCallbacksV6.AggregatorAnswer',
        name: 'a',
        type: 'tuple',
      },
    ],
...
const AGGREGATOR_ABI = [
  {
    inputs: [
      ...
      {
        internalType: 'contractPairsStorageInterfaceV6',
        name: '_pairsStorage',
        type: 'address',
      },
      ...
      {
        internalType: 'contractLpInterfaceV5',
        name: '_tokenDaiLp',
        type: 'address',
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'pairIndex', type: 'uint256' },
      {
        internalType: 'enumGNSTestnetPriceAggregatorV6.OrderType',
        name: 'orderType',
        type: 'uint8',
      },
  ...
  {
    inputs: [{ internalType: 'address', name: '_nftRewards', type: 'address' }],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_minAnswers', type: 'uint256' }],
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: 'orderId', type: 'uint256' },
      {
        ...
        internalType: 'structGNSTestnetPriceAggregatorV6.PendingSl',
        name: 'p',
        type: 'tuple',
      },
    ],
...
const PAIRS_STORAGE_ABI = [
  {
    inputs: [
      { internalType: 'uint256', name: '_currentOrderId', type: 'uint256' },
      {
        internalType: 'contractStorageInterfaceV5',
        name: '_storageT',
        type: 'address',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'nftLimitOrderFeeP', type: 'uint256' },
      { internalType: 'uint256', name: 'referralFeeP', type: 'uint256' },
      { internalType: 'uint256', name: 'minLevPosDai', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
    constant: true,
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'maxCollateralP', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
    constant: true,
    ...
    outputs: [
      ...
      { internalType: 'string', name: 'to', type: 'string' },
      {
        components: [
          ...
          { internalType: 'address', name: 'feed2', type: 'address' },
          {
            internalType: 'enumGNSTestnetPairsStorageV6.FeedCalculation',
            name: 'feedCalculation',
            type: 'uint8',
          },
          { internalType: 'uint256', name: 'maxDeviationP', type: 'uint256' },
        ],
        internalType: 'structGNSTestnetPairsStorageV6.Feed',
        name: 'feed',
        type: 'tuple',
      },
      { internalType: 'uint256', name: 'spreadP', type: 'uint256' },
    ...
    inputs: [
      {
        ...
        internalType: 'structGNSTestnetPairsStorageV6.Pair',
        name: '_pair',
        type: 'tuple',
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: 'structGNSTestnetPairsStorageV6.Group',
        name: '_group',
        type: 'tuple',
      },
    ],
    ...
    inputs: [
      {
        ...
        internalType: 'structGNSTestnetPairsStorageV6.Fee',
        name: '_fee',
        type: 'tuple',
      },
    ],
...
const NFT_REWARDS_ABI = [
    ...
    inputs: [
      {
        ...
        indexed: false,
        internalType: 'structGNSTestnetNftRewardsV6.TriggeredLimitId',
        name: 'id',
        type: 'tuple',
      },
      {
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'enumGNSTestnetNftRewardsV6.OpenLimitOrderType',
        name: '',
        type: 'uint8',
      },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_triggerTimeout', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_sameBlockLimit', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_firstP', type: 'uint256' },
      { internalType: 'uint256', name: '_sameBlockP', type: 'uint256' },
      { internalType: 'uint256', name: '_poolP', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_fromRound', type: 'uint256' },
      { internalType: 'uint256', name: '_toRound', type: 'uint256' },
    ],
...
const VAULT_ABI = [
  ...
  },
  {
    ...
    name: 'storageT',
    outputs: [
      { internalType: 'contractStorageInterfaceV5', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
    constant: true,
  ...
  },
  {
    ...
    name: 'users',
    outputs: [
      { internalType: 'uint256', name: 'daiDeposited', type: 'uint256' },
      { internalType: 'uint256', name: 'maxDaiDeposited', type: 'uint256' },
      { internalType: 'uint256', name: 'withdrawBlock', type: 'uint256' },
      { internalType: 'uint256', name: 'debtDai', type: 'uint256' },
      { internalType: 'uint256', name: 'debtMatic', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
    constant: true,
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_blocksBaseRefill', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_blocksBaseDeplete', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_blocksMinDeplete', type: 'uint256' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_refillLiqP', type: 'uint256' }],
    name: 'setRefillLiqP',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_depleteLiqP', type: 'uint256' },
    ],
    name: 'setDepleteLiqP',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_powerRefill', type: 'uint256' },
    ],
    name: 'setPowerRefill',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_coeffDepleteP', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_thresholdDepleteP', type: 'uint256' },
    ],
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_swapFeeP', type: 'uint256' }],
    name: 'setSwapFeeP',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_withdrawTimelock', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_maxWithdrawP', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_currentBalanceDai', type: 'uint256' },
      { internalType: 'uint256', name: '_maxBalanceDai', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: '', type: 'uint256' },
      {
        ...
        internalType: 'structStorageInterfaceV5.Trader',
        name: '',
        type: 'tuple',
      },
      { internalType: 'uint256[]', name: '', type: 'uint256[]' },
...
if (
  !process.env.WSS_URLS ||
  !process.env.PRICES_URL ||
  !process.env.STORAGE_ADDRESS ||
  !process.env.PRIVATE_KEY ||
  !process.env.PUBLIC_KEY ||
  !process.env.EVENT_CONFIRMATIONS_SEC ||
  !process.env.TRIGGER_TIMEOUT ||
  !process.env.MAX_GAS_PRICE_GWEI ||
  !process.env.CHECK_REFILL_SEC ||
  !process.env.VAULT_REFILL_ENABLED ||
  !process.env.AUTO_HARVEST_SEC ||
...
async function checkLinkAllowance() {
  web3[selectedProvider].eth.net
    .isListening()
    .then(async () => {
      const allowance = await linkContract.methods
        .allowance(process.env.PUBLIC_KEY, process.env.STORAGE_ADDRESS)
        .call()
...
async function selectProvider(n) {
  selectedProvider = n
  storageContract = new web3[n].eth.Contract(
    STORAGE_ABI,
    process.env.STORAGE_ADDRESS,
  )

  const aggregatorAddress = await storageContract.methods
    .priceAggregator()
    .call()
  ...
  const aggregatorContract = new web3[n].eth.Contract(
    AGGREGATOR_ABI,
    aggregatorAddress,
  )
  const pairsStorageAddress = await aggregatorContract.methods
    .pairsStorage()
    .call()
  const nftRewardsAddress = await aggregatorContract.methods.nftRewards().call()
  pairsStorageContract = new web3[n].eth.Contract(
    PAIRS_STORAGE_ABI,
    pairsStorageAddress,
  )
  nftRewardsContract = new web3[n].eth.Contract(
    NFT_REWARDS_ABI,
    nftRewardsAddress,
  )
...
const getProvider = (wssId) => {
  const provider = new Web3.providers.WebsocketProvider(WSS_URLS[wssId], {
    ...
    setTimeout(() => {
      if (provider.connected) {
        ...
        if (connectedProvider === -1 || selectedProvider === null) {
          ...
          console.log(
            'No need to switch WSS, already connected to ' +
              WSS_URLS[selectedProvider],
          )
        }
      }
    }, 1 * 1000)
  ...
  provider.on('error', () => {
    console.log('WSS ' + WSS_URLS[wssId] + ' error')
    provider.disconnect()
  })
  return provider
}
...
setInterval(() => {
  console.log(
    'Current WSS: ' +
      web3[selectedProvider].currentProvider.url +
      ' (#' +
      selectedProvider +
      ')',
  )
  ...
  fetch('https://gasstation-mainnet.matic.network/v2/')
    ...
    .then((r) => {
      maxPriorityFeePerGas = Math.round(
        Math.max(
          Math.round(r.fast.maxPriorityFee) *
            process.env.PRIORITY_GWEI_MULTIPLIER,
          process.env.MIN_PRIORITY_GWEI,
        ),
      )
    ...
    .catch(() => {
      console.log('Error while fetching fastest gwei from gas station.')
    })
}, 3 * 1000)
...
async function fetchTradingVariables() {
  web3[selectedProvider].eth.net
    ...
    .then(async () => {
      ...
      const nftSuccessTimelock = await storageContract.methods
        .nftSuccessTimelock()
        .call()
      const pairsCount = await pairsStorageContract.methods.pairsCount().call()
      nfts = []

      const nftsCount1 = await nftContract1.methods
        .balanceOf(process.env.PUBLIC_KEY)
        .call()
      const nftsCount2 = await nftContract2.methods
        .balanceOf(process.env.PUBLIC_KEY)
        .call()
      const nftsCount3 = await nftContract3.methods
        .balanceOf(process.env.PUBLIC_KEY)
        .call()
      const nftsCount4 = await nftContract4.methods
        .balanceOf(process.env.PUBLIC_KEY)
        .call()
      const nftsCount5 = await nftContract5.methods
        .balanceOf(process.env.PUBLIC_KEY)
        .call()

      for (var i = 0; i < nftsCount1; i++) {
        const id = await nftContract1.methods
          .tokenOfOwnerByIndex(process.env.PUBLIC_KEY, i)
          .call()
        nfts.push({ id: id, type: 1 })
      }
      for (var i = 0; i < nftsCount2; i++) {
        const id = await nftContract2.methods
          .tokenOfOwnerByIndex(process.env.PUBLIC_KEY, i)
          .call()
        nfts.push({ id: id, type: 2 })
      }
      for (var i = 0; i < nftsCount3; i++) {
        const id = await nftContract3.methods
          .tokenOfOwnerByIndex(process.env.PUBLIC_KEY, i)
          .call()
        nfts.push({ id: id, type: 3 })
      }
      for (var i = 0; i < nftsCount4; i++) {
        const id = await nftContract4.methods
          .tokenOfOwnerByIndex(process.env.PUBLIC_KEY, i)
          .call()
        nfts.push({ id: id, type: 4 })
      }
      for (var i = 0; i < nftsCount5; i++) {
        const id = await nftContract5.methods
          .tokenOfOwnerByIndex(process.env.PUBLIC_KEY, i)
          .call()
      ...
      Promise.all(pairsPromises).then(async (s) => {
        for (var j = 0; j < s.length; j++) {
          const openInterestLong = await storageContract.methods
            .openInterestDai(j, 0)
            .call()
          const openInterestShort = await storageContract.methods
            .openInterestDai(j, 1)
            .call()
          const openInterestMax = await storageContract.methods
            .openInterestDai(j, 2)
            .call()
          openInterests[j] = {
          ...
          const collateralLong = await pairsStorageContract.methods
            .groupsCollaterals(j, 0)
            .call()
          const collateralShort = await pairsStorageContract.methods
            .groupsCollaterals(j, 1)
            .call()
          const collateralMax = await pairsStorageContract.methods
            .groupMaxCollateral(j)
            .call()
          collaterals[j] = {
            long: collateralLong,
...
async function selectNft() {
  return new Promise(async (resolve) => {
    if (nftTimelock === undefined || nfts.length === 0) {
      resolve(null)
      return
    }
    ...
    web3[selectedProvider].eth.net
      ...
      .then(async () => {
        ...
        for (var i = 0; i < nfts.length; i++) {
          const lastSuccess = await storageContract.methods
            .nftLastSuccess(nfts[i].id)
            .call()
          if (
            parseFloat(currentBlock) - parseFloat(lastSuccess) >= nftTimelock &&
...
async function fetchOpenTrades() {
  web3[selectedProvider].eth.net
    ...
    .then(async () => {
      ...
      const openLimitOrders = await storageContract.methods
        .getOpenLimitOrders()
        .call()
      for (let i = 0; i < openLimitOrders.length; i++) {
        const l = openLimitOrders[i]
        openLimitOrdersTypesPromises.push(
          nftRewardsContract.methods
            .openLimitOrderTypes(l.trader, l.pairIndex, l.index)
            .call(),
        )
      }
      ...
      for (let i = 0; i < spreadsP.length; i++) {
        promisesPairTradersArray.push(
          storageContract.methods.pairTradersArray(i).call(),
        )
      }
        ...
        Promise.all(promisesPairTradersArray).then(async (r) => {
          ...
          for (let j = 0; j < r.length; j++) {
            for (let a = 0; a < r[j].length; a++) {
              for (let b = 0; b < maxTradesPerPair; b++) {
                promisesTrade.push(
                  storageContract.methods.openTrades(r[j][a], j, b).call(),
                )
              }
            }
          }
          ...
          Promise.all(promisesTrade).then((trades) => {
            for (let j = 0; j < trades.length; j++) {
              if (trades[j].leverage.toString() === '0') {
                continue
              }
  ...
  web3[selectedProvider].eth.net
    ...
    .then(async () => {
      if (eventSubTrading === null) {
        eventSubTrading = tradingContract.events
      ...
      if (eventSubCallbacks === null) {
        eventSubCallbacks = callbacksContract.events
          .allEvents({ fromBlock: 'latest' })
          .on('data', function (event) {
            const eventName = event.event.toString()
  ...
  web3[selectedProvider].eth.net
    ...
    .then(async () => {
      ...
      if (
        ...
        const pairIndex =
          eventName === 'OpenLimitCanceled' ? v.pairIndex : v.t[1]
        const index = eventName === 'OpenLimitCanceled' ? v.index : v.limitIndex

        const hasLimitOrder = await storageContract.methods
          .hasOpenLimitOrder(trader, pairIndex, index)
          .call()
      ...
      if (eventName === 'OpenLimitPlaced' || eventName === 'OpenLimitUpdated') {
        const hasLimitOrder = await storageContract.methods
          .hasOpenLimitOrder(v.trader, v.pairIndex, v.index)
          .call()

        if (hasLimitOrder.toString() === 'true') {
          const id = await storageContract.methods
            .openLimitOrderIds(v.trader, v.pairIndex, v.index)
            .call()
          const limit = await storageContract.methods.openLimitOrders(id).call()
          let found = false

          const type = await nftRewardsContract.methods
            .openLimitOrderTypes(v.trader, v.pairIndex, v.index)
            .call()
          limit.type = type

          for (var i = 0; i < openTrades.length; i++) {
            if (
              openTrades[i].trader === v.trader &&
      ...
      if (
        (eventName === 'MarketExecuted' && v.open.toString() === 'true') ||
        (eventName === 'LimitExecuted' && v.orderType.toString() === '3') ||
        eventName === 'TpUpdated' ||
        eventName === 'SlUpdated' ||
        eventName === 'SlCanceled' ||
        ...
        const trader =
          eventName !== 'MarketExecuted' && eventName !== 'LimitExecuted'
            ? v.trader
            : v.t[0]
        const pairIndex =
          eventName !== 'MarketExecuted' && eventName !== 'LimitExecuted'
        ...
        const trade = await storageContract.methods
          .openTrades(trader, pairIndex, index)
          .call()
      ...
      if (
        (eventName === 'MarketExecuted' && v.open.toString() === 'false') ||
        (eventName === 'LimitExecuted' && v.orderType !== '3')
      ) {
        const trade = await storageContract.methods
          .openTrades(v.t[0], v.t[1], v.t[2])
          .call()
      ...
      if (failed) {
        ...
        console.log(
          'Watch events (' +
            eventName +
            '): Trade not found on the blockchain, trying again in ' +
            process.env.EVENT_CONFIRMATIONS_SEC / 2 +
            ' seconds.',
        )
      }
    })
...
function alreadyTriggered(trade, orderType) {
  for (var i = 0; i < ordersTriggered.length; i++) {
    if (ordersTriggered[i].orderType === orderType) {
      ...
      if (
        trade.trader === t.trader &&
        trade.pairIndex === t.pairIndex &&
        trade.index === t.index
      ) {
        return true
      }
  ...
  socket.onmessage = async (msg) => {
    ...
    if (spreadsP.length > 0 && allowedLink) {
      ...
      for (var i = 0; i < openTrades.length; i++) {
        ...
        if (isForexMarketClosed && t.pairIndex >= 21 && t.pairIndex <= 30)
          continue
        ...
        if (t.openPrice !== undefined) {
          ...
          if (
            tp.toString() !== '0' &&
            ((buy && price >= tp) || (!buy && price <= tp))
          ) {
            orderType = 0
          } else if (
            sl.toString() !== '0' &&
            ((buy && price <= sl) || (!buy && price >= sl))
          ) {
            orderType = 1
          } else if (
            sl.toString() === '0' &&
            ((buy && price <= liqPrice) || (!buy && price >= liqPrice))
          ) {
            orderType = 2
          }
        } else {
          const spread =
            ((spreadsP[t.pairIndex] / 1e10) * (100 - t.spreadReductionP)) / 100
          const priceIncludingSpread = !buy
            ? price * (1 - spread / 100)
            : price * (1 + spread / 100)
          const interestDai = buy
            ? parseFloat(openInterests[t.pairIndex].long)
            : parseFloat(openInterests[t.pairIndex].short)
          const collateralDai = buy
            ? parseFloat(collaterals[t.pairIndex].long)
            : parseFloat(collaterals[t.pairIndex].short)
          const newInterestDai =
            interestDai + parseFloat(t.leverage) * parseFloat(t.positionSize)
          ...
          if (
            ...
            if (
              (t.type.toString() === '0' &&
                priceIncludingSpread >= minPrice &&
                priceIncludingSpread <= maxPrice) ||
              (t.type.toString() === '1' &&
                (buy
                  ? priceIncludingSpread <= maxPrice
                  : priceIncludingSpread >= minPrice)) ||
              ...
              if (error) {
                ...
                const tx = {
                  ...
                  data: tradingContract.methods
                    ...
                    .encodeABI(),
                  maxPriorityFeePerGas: web3[selectedProvider].utils.toHex(
                    maxPriorityFeePerGas * 1e9,
                  ),
                  maxFeePerGas: web3[selectedProvider].utils.toHex(
                    process.env.MAX_GAS_PRICE_GWEI * 1e9,
                  ),
                  gas: web3[selectedProvider].utils.toHex('2000000'),
                }

                web3[selectedProvider].eth.accounts
                  .signTransaction(tx, process.env.PRIVATE_KEY)
                  .then((signed) => {
                    web3[selectedProvider].eth
                      ...
                      .on('receipt', () => {
                        ...
                        setTimeout(() => {
                          ordersTriggered = ordersTriggered.filter(
                            (item) =>
                              JSON.stringify(item) !==
                              JSON.stringify({
                          ...
                          nftsBeingUsed = nftsBeingUsed.filter(
                            (item) => item !== orderInfo.nftId,
                          )
                        }, process.env.TRIGGER_TIMEOUT * 1000)
                      })
                      .on('error', (e) => {
                        console.log(
                          'Failed to trigger (order type: ' +
                            orderInfo.name +
                            ', nft id: ' +
                            orderInfo.nftId +
                            ')',
...
if (process.env.AUTO_HARVEST_SEC > 0) {
  ...
  async function claimPoolTokens() {
    ...
    nftRewardsContract.methods
      .claimPoolTokens(fromRound, toRound)
      .estimateGas({ from: process.env.PUBLIC_KEY }, (error, result) => {
        if (!error) {
          const tx = {
            from: process.env.PUBLIC_KEY,
            to: nftRewardsContract.options.address,
            data: nftRewardsContract.methods
              .claimPoolTokens(fromRound, toRound)
              .encodeABI(),
            maxPriorityFeePerGas: web3[selectedProvider].utils.toHex(
              maxPriorityFeePerGas * 1e9,
